	...
	<div class="painel">
		<c:forEach items="${cds}" var="cd">
			<div class="container">
				...
				<div class="cd-menu">
					<p class="menu-fonte"><a class="desabilita-link" href="adicionarCarrinho?idCd=${cd.idCD}">Comprar<span class="glyphicon glyphicon-shopping-cart icone"	aria-hidden="true"></span></a></p>
				...
				<div class="cd-info">
					<div>
						...
						<c:if test="${empty cd.capa}">
							<img class="imagem-miniatura" src="imagens/not-found.jpg" />
						</c:if>
